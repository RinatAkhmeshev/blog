...
<div class="container">
  <div class="row">
    <div class="col-sm-3">
        <p><span class="label label-primary">простой блог,тестовое задание</span></p>
      </div>
    </div>
    <div class="row">
      <div class="col-sm-3">
      ...
      <div class="col-sm-3">
        <div class="jumbotron">
          <p><span class="label label-primary">Материал 0</span></p>
        </div>
      </div>
      <div class="col-sm-3">
        <div class="jumbotron">
          <p><span class="label label-primary">Посетитель 0</span></p>
        </div>
      </div>
      <div class="col-sm-3">
        <div class="jumbotron">
